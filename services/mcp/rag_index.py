"""Dependency-free document index for the RAG agent.
...
API — sparse lexical retrieval keeps the demo self-contained and offline-testable
while still being real RAG retrieval.
...
class DocIndex:
    """In-memory BM25 index over the chunked markdown corpus."""
